...
export function ReservePublicFooter() {
  ...
  const cardClass =
    "rounded-[20px] border border-green-200 border-l-4 border-l-green-600 bg-green-50/80 p-5 pl-6 text-center shadow-sm sm:text-left";

  return (
    <footer className="mt-auto border-t border-slate-200 bg-white">
      <div className="mx-auto grid max-w-[1280px] gap-3 px-4 py-5 sm:gap-4 sm:px-6 sm:py-8 md:px-8 md:py-12 lg:grid-cols-2 lg:gap-6 lg:px-10">
