...
export function TournamentInquiryDetailManageClient({
  ...
  const [copyEmailState, setCopyEmailState] = useState<"idle" | "ok" | "err">("idle");
  const [copyPhoneState, setCopyPhoneState] = useState<"idle" | "ok" | "err">("idle");
    ...
    <div className="space-y-6 rounded-lg border border-zinc-200 bg-zinc-50/80 p-4 sm:p-5">
      ...
      <div>
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
          <button
            type="button"
            onClick={() => void copyText(contactEmail.trim(), (v) => setCopyEmailState(v))}
