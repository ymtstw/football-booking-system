-- 合宿占有（camp_status）を撤去し、create_public_reservation を合宿チェック前の定義に戻す。
...
ALTER TABLE public.event_days DROP COLUMN IF EXISTS camp_status;

DROP TYPE IF EXISTS public.event_day_camp_status;
