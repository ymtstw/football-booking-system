...
| 項目      | 内容                                                                                |
| ------- | --------------------------------------------------------------------------------- |
| 版       | MVP最終版 / 2026-04-06（枠数・代表学年・午後編成を 2026-04-15 追記。枠編集の予約ガード・強制 API を 2026-04-15 追記） |
| 作成      | 鹿島 大和                                                                             |
| 更新日     | 2026-04-15（枠編集ポリシー追記）                                                             |
...
| 02  | 12:01         | 午前補完・午後一括編成                | 3〜6チームで実行。結果確定。Cron: UTC `1 3 * * *`                      |
